...
const EXERCISE_DB = [
  ...
  // === 肩部训练 ===
  { name: '坐姿哑铃推举', icon: '🙆', cat: 'strength', kcal30: 210, desc: '三角肌前中束核心动作' },
  { name: '站姿杠铃推举', icon: '🏋️', cat: 'strength', kcal30: 240, desc: '过头推举，肩部力量基石' },
  { name: '阿诺德推举', icon: '💪', cat: 'strength', kcal30: 220, desc: '旋转推举，全三角肌' },
  { name: '哑铃耸肩', icon: '🤷', cat: 'strength', kcal30: 130, desc: '斜方肌上部训练' },
  { name: '杠铃耸肩', icon: '🤷', cat: 'strength', kcal30: 150, desc: '大重量斜方肌训练' },
  { name: '杠铃直立划船', icon: '⬆️', cat: 'strength', kcal30: 160, desc: '三角肌+斜方肌' },
  { name: '绳索侧平举', icon: '🪢', cat: 'strength', kcal30: 125, desc: '持续张力刺激中束' },
  { name: '蝴蝶机反向飞鸟', icon: '🦋', cat: 'strength', kcal30: 135, desc: '后束三角肌孤立' },
  { name: '古巴推举', icon: '🇨🇺', cat: 'strength', kcal30: 170, desc: '肩袖肌群+三角肌' },
  { name: '肩外旋训练', icon: '🔄', cat: 'strength', kcal30: 80, desc: '肩袖肌群康复训练' },
  { name: '杠铃前平举', icon: '🫴', cat: 'strength', kcal30: 125, desc: '前束大重量刺激' },

  // === 背部训练 ===
  { name: '引体向上（宽握）', icon: '🧗', cat: 'strength', kcal30: 230, desc: '背阔肌宽度之王' },
  { name: '引体向上（窄握）', icon: '🧗', cat: 'strength', kcal30: 215, desc: '背阔肌下沿+二头' },
  { name: '对握引体向上', icon: '🧗', cat: 'strength', kcal30: 210, desc: '掌心相对，肩关节友好' },
  { name: '负重引体向上', icon: '🏋️', cat: 'strength', kcal30: 260, desc: '挂片/负重腰带' },
  { name: 'T杠划船', icon: '🏋️', cat: 'strength', kcal30: 250, desc: '中背部厚度轰炸' },
  { name: '潘德雷划船', icon: '🚣', cat: 'strength', kcal30: 240, desc: '爆发力划船，背阔肌' },
  { name: '单臂哑铃划船', icon: '🚣', cat: 'strength', kcal30: 215, desc: '单侧精准刺激' },
  { name: '直臂下拉', icon: '⬇️', cat: 'strength', kcal30: 155, desc: '背阔肌孤立收缩' },
  { name: '对握高位下拉', icon: '⬇️', cat: 'strength', kcal30: 195, desc: '中背部厚度' },
  { name: '颈后高位下拉', icon: '⬇️', cat: 'strength', kcal30: 190, desc: '背阔肌宽度（注意安全）' },
  { name: '仰卧直臂上拉', icon: '🏋️', cat: 'strength', kcal30: 160, desc: '背阔肌+胸肌拉伸' },
  { name: '山羊挺身', icon: '🐐', cat: 'strength', kcal30: 170, desc: '下背部竖脊肌' },
  { name: '地雷管划船', icon: '🏋️', cat: 'strength', kcal30: 210, desc: '单侧背部+核心' },
  { name: '架上硬拉', icon: '🏋️', cat: 'strength', kcal30: 270, desc: '半程硬拉，背部中上部' },
  { name: '绳索面拉', icon: '🧵', cat: 'strength', kcal30: 145, desc: '后束+肩袖+上背' },
  { name: '弹力带划船', icon: '🪢', cat: 'strength', kcal30: 140, desc: '居家背部训练' },

  // === 二头肌训练 ===
  { name: '集中弯举', icon: '💪', cat: 'strength', kcal30: 130, desc: '孤立二头肌顶峰收缩' },
  { name: '斜板哑铃弯举', icon: '💪', cat: 'strength', kcal30: 145, desc: '二头肌长头拉伸' },
  { name: '牧师凳弯举', icon: '🙏', cat: 'strength', kcal30: 140, desc: 'EZ杠/哑铃，消除借力' },
  { name: '绳索弯举', icon: '🪢', cat: 'strength', kcal30: 135, desc: '持续张力泵感' },
  { name: '反向弯举', icon: '↩️', cat: 'strength', kcal30: 120, desc: '肱肌+前臂伸肌' },
  { name: '佐特曼弯举', icon: '💪', cat: 'strength', kcal30: 140, desc: '二头+前臂旋转训练' },
  { name: '21响礼炮', icon: '🔫', cat: 'strength', kcal30: 170, desc: '7下半程+7上半程+7全程' },
  { name: '蜘蛛弯举', icon: '🕷️', cat: 'strength', kcal30: 145, desc: '俯身斜板弯举' },
  { name: '上斜锤式弯举', icon: '💪', cat: 'strength', kcal30: 140, desc: '长头拉伸+肱肌' },
  { name: '窄握杠铃弯举', icon: '💪', cat: 'strength', kcal30: 155, desc: '二头外侧头' },
  { name: '宽握杠铃弯举', icon: '💪', cat: 'strength', kcal30: 150, desc: '二头内侧短头' },
  { name: '弹力带弯举', icon: '🪢', cat: 'strength', kcal30: 110, desc: '居家二头训练' },

  // === 三头肌训练 ===
  { name: '绳索下压', icon: '🪢', cat: 'strength', kcal30: 160, desc: '三头肌外侧头泵感' },
  { name: '仰卧臂屈伸', icon: '💀', cat: 'strength', kcal30: 170, desc: 'Skull Crusher 三头轰炸' },
  { name: '颈后哑铃臂屈伸', icon: '💪', cat: 'strength', kcal30: 155, desc: '三头长头训练' },
  { name: '双杠臂屈伸', icon: '🏗️', cat: 'strength', kcal30: 200, desc: '自重三头+胸下沿' },
  { name: '反握绳索下压', icon: '🪢', cat: 'strength', kcal30: 145, desc: '三头内侧头' },
  { name: '单臂绳索下压', icon: '🪢', cat: 'strength', kcal30: 135, desc: '单侧精准修正' },
  { name: '哑铃后踢', icon: '🦵', cat: 'strength', kcal30: 120, desc: '三头长头孤立' },
  { name: '窄距杠铃卧推', icon: '🏋️‍♂️', cat: 'strength', kcal30: 225, desc: '三头肌大重量训练' },
  { name: '凳上臂屈伸', icon: '🪑', cat: 'strength', kcal30: 155, desc: '自重/负重三头训练' },
  { name: '弹力带下压', icon: '🪢', cat: 'strength', kcal30: 110, desc: '居家三头训练' },
